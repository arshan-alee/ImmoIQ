  ...
  return (
    <div className="bg-white py-8 px-6 rounded-lg shadow-md flex gap-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-primary text-11 mt-3">
            ...
            <div className="flex justify-between items-center mt-9 xl:text-base lg:text-sm">
              <div>
                <p className="text-grey-light font-thin text-sm">Sietenanzahl</p>
              ...
              <div>
                <p className="text-grey-light font-thin text-sm">Letztes Update</p>
              ...
              <div>
                <p className="text-grey-light font-thin text-sm">Dateiformat</p>
                <div className="flex gap-1">
